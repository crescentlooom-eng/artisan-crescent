...
export default function LoginPage() {
  ...
  return (
    <div data-testid="login-page" className="page-fade min-h-screen grid lg:grid-cols-2">
      {/* Left — form */}
      <div className="flex items-center justify-center pt-28 pb-16 px-6 md:px-16">
        <div className="max-w-md w-full">
                    <div className="text-[11px] tracking-[0.4em] uppercase mb-4" style={{ color: "var(--cl-text)" }}>The House</div>
          <h1 className="font-serif-display text-4xl md:text-5xl leading-[1.05]" style={{ color: "var(--cl-text)" }}>
            Welcome to <span className="italic" style={{ color: "var(--cl-text)" }}>Crescent Loom.</span>
          </h1>
          ...
          <p className="text-[10px] tracking-[0.25em] uppercase mt-10" style={{ color: "var(--cl-subtext)" }}>
