...
const Section = ({ title, children }) => (
  <div className="border-t border-[#B8C0C8]/15 pt-10 mt-10">
    <div className="text-[11px] tracking-[0.4em] uppercase text-[#B8C0C8] mb-4">{title}</div>
...
export default function ShippingPage() {
  return (
    <div className="page-fade pt-32 pb-24 max-w-3xl mx-auto px-6 md:px-12">
      <div className="text-[11px] tracking-[0.4em] uppercase text-[#B8C0C8] mb-4">Delivery</div>
      <h1 className="font-serif-display text-5xl md:text-6xl text-[#F5F0E8] leading-[0.95]">
        Shipping & <span className="italic text-[#B8C0C8]/90">Delivery</span>
      </h1>
        ...
        <ul className="space-y-2 mt-2">
          {[
            ...
            <li key={item} className="flex items-start gap-3">
              <span className="text-[#B8C0C8] mt-1">—</span>
              <span>{item}</span>
            </li>
          ))}
        </ul>
      ...
      <Section title="Order Tracking">
        <p>
          ...
          <a href="https://www.delhivery.com/track/" target="_blank" rel="noopener noreferrer" className="text-[#B8C0C8] gold-underline">
            Delhivery website
          </a>
          .
        </p>
        ...
        <ul className="space-y-2 mt-2">
          {["+91 9810924300", "+91 8810607608", "+91 8920989377"].map((num) => (
            <li key={num} className="flex items-center gap-3">
              ...
              <a href={`https://wa.me/91${num.replace(/\D/g, "")}`} className="text-[#B8C0C8] gold-underline">{num}</a>
            </li>
          ))}
        </ul>
        <p className="mt-4">
          Or email us at{" "}
          <a href="mailto:crescent.looom@gmail.com" className="text-[#B8C0C8] gold-underline">
            crescent.looom@gmail.com
          </a>
        </p>
      </Section>

      <div className="mt-16 pt-10 border-t border-[#B8C0C8]/15 flex flex-wrap gap-6">
