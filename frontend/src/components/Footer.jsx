        ...
        <div className="border-t border-[#C9A96E]/10">
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-2 text-[11px] tracking-[0.25em] uppercase text-[#8A8FA8]">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/crescentloom" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-[#C9A96E] transition-colors">
              ...
              <a href="https://www.facebook.com/crescentloom" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-[#C9A96E] transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
